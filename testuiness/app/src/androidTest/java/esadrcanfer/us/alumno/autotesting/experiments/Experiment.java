...
public abstract class Experiment {
    ...
    /**
     * This is the constructor of the {@link Experiment} class.
     * @param id The ID of the test generated by the 'createTestData' method.
     * <p><p>
     * @param path The path of the test inside assets (no initial '/' needed).
     * <p><p>
     * @param algorithm The algorithm to use ('Random Algorithm', 'WATER Algorithm' or 'GRASP Algorithm').
     * <p><p>
     * @param experimentPath The experiment directory's path (no initial or final '/' needed)
     */
    public Experiment(String id, String path, String algorithm, String experimentPath) {
        this.id = id;
        this.path = path;
     ...
     */
    protected static Collection<String> createTestData(List<String> tests, int numberOfExec, List<String> algorithms, String experimentPath){
        ...
        CheckpointUtil checkpoints = new CheckpointUtil(downloadsPath+"/"+experimentPath, testSuite, algorithms);
    ...
    protected void runTest(long timeout) throws UiObjectNotFoundException {
        ...
        String downloadsPath = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getPath();
        CheckpointUtil checkpoints = new CheckpointUtil(downloadsPath+"/"+experimentPath);
